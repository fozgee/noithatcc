...
overrides : [ { element : 'font', attributes : { 'color' : null } } ] }";
			...
			GlobalConfigObj.filebrowserImageBrowseLinkUrl = "/upload.aspx";
			GlobalConfigObj.filebrowserImageBrowseUrl = "/upload.aspx";
			GlobalConfigObj.filebrowserImageUploadUrl = "/upload.aspx";
			GlobalConfigObj.filebrowserUploadUrl = "/upload.aspx";
